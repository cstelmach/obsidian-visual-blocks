...
| Phase 12 — Migration tool: legacy → new layout | In Progress — rename prep complete | 2026-05-02 08:38 | | 6a64cc6c3 (auto-backup rename capture) + 25bb544bc (prep) | python 169/169 ✓ + jest 79/79 ✓ + build ✓ + obsidian-verify canary ✓ + migration dry-run ✓ | | Plugin/product renamed to Visual Blocks before destructive migration. Real migration not executed yet; requires explicit approval after dry-run. |
